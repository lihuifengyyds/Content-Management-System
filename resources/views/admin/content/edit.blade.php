        ...
        <div style="width: 543px">
            ...
            <form action="{{ url('content/save') }}" class="j-form" method="POST">
                    ...
                    <div class="col-sm-10">
                        <select name="cid" id="" class="form-control" style="width:200px;">
                            ...
                            @foreach ($category as $v)
                                <option value="{{ $v['id'] }}" {{ $content->cid == $v['id'] ? 'selected' : '' }}>
                                    @if ($v['level'])
                                        |---
                                    @endif {{ $v['name'] }}
                                </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="title" class="form-control" style="width:200px;" value="{{ $content->title }}">
                    </div>
                </div>
                {{-- 上传图片按钮 --}}
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="upload-img-box" id="uploadImg">
                            ...
                            <div class="upload-pre-item" style="max-height:100%;">
                                <img src="/static/upload/{{ $content->image }}" style="width:100px;height:100px">
                                <input type="hidden" name="image" value="{{ $content->image }}" class="icon_banner">
                            </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="content" class="j-content" style="height:500px;">{{ $content->content }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
